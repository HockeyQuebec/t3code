...
import Migration0054 from "./Migrations/054_ScheduledTurns.ts";
import Migration0055 from "./Migrations/055_ScheduledTurnsOrigin.ts";
import Migration0056 from "./Migrations/056_RepairRenumberedMigrations.ts";
...
const migrationEntries = [
  ...
  [54, "ScheduledTurns", Migration0054],
  [55, "ScheduledTurnsOrigin", Migration0055],
  [56, "RepairRenumberedMigrations", Migration0056],
] as const;
